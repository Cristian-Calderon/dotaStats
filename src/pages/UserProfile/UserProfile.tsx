        ...
        <IonPage className='padding-top'>
            <IonContent className="">
                <UserContent>
                    ...
                    <Info title={'Ubicacion'} subtitle={'Ver host actual'} description={'La ubicacion es estimada por seguridad pero te brinda informacion a que hosting estas conectado'} buttonText={'Ver mapa'} ></Info>

                    <Info title={'Cuenta de Steam'} subtitle={'Tu Steam IDs es STEAM_0:155102323'} description={'La cuenta de Steam asociada con este jugador de Dota Buff es 110202203'} buttonText={'Cerrar sesion'} ></Info>
